...
namespace LaurasLearningDiary.Controllers
{
    public class TopicsController : Controller
    {
        private readonly LaurasLearningDiaryContext _context;

        public TopicsController(LaurasLearningDiaryContext context)
        {
            _context = context;
        }
